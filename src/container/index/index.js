export class Todo{
    ...
    static init = ()=>{
        ...
        this.#block = document.querySelector('.card__list')
        this.#input = document.querySelector('.add__input')
        this.#button = document.querySelector('.add__button')
    ...
    static #createTaskElem = (data)=>{
        ...
        if(data.done){
            el.classList.add('item_done')
            btnDo.classList.remove('button_do')
            btnDo.classList.add('button_done')
        }
    ...
    static #handleDo = (data, btn, el)=>()=>{
        ...
        if(result === true || result === false){
            el.classList.toggle('item_done')
            btn.classList.toggle('button_do')
            btn.classList.toggle('button_done')
